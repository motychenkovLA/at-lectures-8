...
public class JunitTest {
        ...
        @Description("Двойной клик, правый клик, динамический клик")
        @Test
        ...
        @Description("Принимаем и отклоняем алерт")
        @Test
        ...
        @DisplayName("Тест с окном браузера")
        @Description("Открываем вторую вкладку")
        @Test
